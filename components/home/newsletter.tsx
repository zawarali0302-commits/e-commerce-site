  ...
  return (
    <section className="bg-[#f0ebe3] px-6 md:px-10 py-20 md:py-24 text-center">
      ...
      <p className="text-sm text-[#6b5d52] mb-8 font-light">
        New arrivals, exclusive offers, and style inspiration — straight to your
        inbox.
      </p>
      {submitted ? (
        <p className="text-sm tracking-[0.1em] text-[#2a1f18] font-light">
        ...
        >
          ...
          <button
            type="submit"
            className="px-8 py-3.5 bg-[#2a1f18] text-[#f0ebe3] text-[10px] tracking-[0.2em] uppercase font-normal hover:bg-[#3d2f25] transition-colors whitespace-nowrap"
          >
            Subscribe
          </button>
        </form>
